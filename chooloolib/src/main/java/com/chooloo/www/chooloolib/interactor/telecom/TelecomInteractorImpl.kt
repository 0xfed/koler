...
class TelecomInteractorImpl @Inject constructor(
    ...
    override fun handleSecretCode(code: String): Boolean {
        ...
        if (secretCode.equals("007")) {
            // BlackBox integration - Launch Activity to handle it
            try {
                val intent = Intent("com.chooloo.www.koler.BLACKBOX_LAUNCHER")
                intent.setClassName(context.packageName, "com.chooloo.www.koler.ui.blackbox.BlackBoxLauncherActivity")
